...
<%
    ...
    ArrayList<Comment> list=commentdao.findAllCommentByName(found.getId());
    System.out.println(list.size());
%>
<form method="post" action="/CommentFoundServlet">
    <div class="container">
        <div class="jumbotron">
            <p align="center"><span style="font-size: 22px"><b><%=found.getTitle()%></b></span></p>
            <p align="center"><span style="font-size:12px;"><b>发布时间：</b><input id="pubtime" type="text" value="<%=timeFormat2%>" readonly="readonly"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>拾物编号：</b><input type="text" id="objectid" name="objectid" value="<%=found.getId()%>" readonly="readonly"/> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>物品状态：</b><input id="state" type="text" value="<%=found.getState()%>" readonly="readonly"/></span></p>
            <div id="fontsize">
                <p ><span ><b>拾物类别 : <%=found.getSort()%></b></span></p>
                <p ><span ><b>拾获时间 : <%=timeFormat1%></b></span></p>
                <p ><span ><b>拾取地点 : <%=found.getAddress()%></b></span></p>
                <p ><span ><b>联系人 : <%=user.getRealname()%></b></span></p>
                <p ><span ><b>联系方式 : <%=user.getTel()%></b></span></p>
                <p><span><b>联系地址 : <%=user.getAddress()%></b></span></p>
                <p ><span ><b>物品图片 : <img id="photo" src="upload/<%=found.getPhoto()%>"></b></span></p>
            </div>
