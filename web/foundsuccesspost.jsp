...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            <a class="navbar-brand" href="foundinfo.jsp">返回</a>
        </div>
...
<%
    ...
    found=founddao.findFoundByName(currentUser);
...
<form>
    <div class="container">
        <div class="jumbotron">
            ...
            <p align="center"><span style="font-size:12px;"><b>发布时间：</b><%=timeFormat2%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>拾物编号：</b><%=found.getId()%>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>物品状态：</b><%=found.getState()%></span></p>
            <div id="fontsize">
