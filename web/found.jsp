...
<form action="/FoundServlet" method="post" id="myform" class="form-horizontal" role="form" enctype="multipart/form-data">
    <div class="form-group">
        ...
        <div class="col-sm-3">
            <input name="title" type="text" class="form-control" placeholder="如捡到某某身份证">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label class="col-sm-5 control-label">拾获日期</label>
        <div class="col-sm-3">
            <div class='input-group date' id='datetimepicker1'>
                <input name="pickday" type='text' class="form-control" />
    ...
    <div class="form-group">
        <label class="col-sm-5 control-label">拾获地址</label>
        <div class="col-sm-3">
