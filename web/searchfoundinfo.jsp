...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        ...
        <div id="icon" class="navbar-brand">招领启事信息</div>
    </div>
</nav>
<div class="container">
    <p><b>快速筛选</b></p>
    <div class="jumbotron">
        <form action="/CFSearchServlet" method="post" id="myform" class="form-horizontal" role="form">
...
<%
    ArrayList<Found> list= (ArrayList<Found>) request.getAttribute("searchlist");
%>
<div class="row">
    <%
    ...
    <div class="col-sm-2">
        <div class="thumbnail">
            <a href="onefoundinfo.jsp?id=<%=list.get(i).getId()%>">
